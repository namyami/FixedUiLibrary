-- inveris was here
-- i deleted the old one because it was samet's version (his color looks shit but im just saying)
-- yup
...
-- // Extension
local Render = loadstring(game:HttpGet("https://raw.githubusercontent.com/namyami/Repository/refs/heads/main/Reupload/sametexe001/DrawingExtension.lua"))();
...
do
    ...
    function Library:Window(Properties)
        ...
        local Cursor = Library:NewDrawing('Triangle', {
            Theme = "Accent",
            Visible = true,
            Filled = true,
            ZIndex = 1000,
        })
        local CursorOutline = Library:NewDrawing('Triangle', {
            Theme = "Border1",
            Visible = true,
            Filled = true,
            ZIndex = 999,
        ...
        game:GetService("UserInputService").InputBegan:Connect(function(input, gaypornevent)
            if gaypornevent then return end;
            -- gaypornevent (nam's favorite)
            -- ??? lol?
            if input.KeyCode == Library.UIBind then
                Window.Open = not Window.Open;
                MainFrame.Visible = Window.Open;
                Library.Open = not Library.Open;
                CursorOutline.Visible = Library.Open;
