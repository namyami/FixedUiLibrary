...
local drawing = loadstring(game:HttpGet("https://raw.githubusercontent.com/namyami/Utility/refs/heads/main/Drawing/Extension.lua"))();
local tween = loadstring(game:HttpGet("https://raw.githubusercontent.com/namyami/Utility/refs/heads/main/Tween.Lua"))() -- shhhh
local signal = loadstring(game:HttpGet('https://raw.githubusercontent.com/namyami/Utility/refs/heads/main/Signal.Lua'))()
...
local images = {
    ['gradient90'] = "https://github.com/inveris1337/storage/blob/main/image/boui_ui/GeMU2Ke.png?raw=true";
    ['gradient180'] = "https://github.com/inveris1337/storage/blob/main/image/boui_ui/wpDRqVH.png?raw=true";
    ['arrow_down'] = "https://github.com/inveris1337/storage/blob/main/image/boui_ui/tVqy0nL.png?raw=true";
    ['arrow_up'] = "https://github.com/inveris1337/storage/blob/main/image/boui_ui/SL9cbQp.png?raw=true";
}



local folder_path = settings.folder_name .. "/assets"
...
for i, v in next, images do
	local file_path = folder_path .. "/" .. i .. ".png"

	if not isfile(file_path) then
		writefile(file_path, game:HttpGet(v))
	end

	images[i] = getcustomasset(file_path)
end
