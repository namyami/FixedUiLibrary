local function getDarkerColor(color, factor)
    factor = factor or 0.5 -- Default factor to 0.8 if not provided
    ...
    -- library functions 
        function library:window(properties) 
            ...
            -- playerlist 
                ...
                local priority_label = library:create("TextLabel", {
                    ...
                    TextSize = 12,
                    BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                }); library:apply_theme(priority_label, "text", "TextColor3") 
                ...
                local function create_player(player)
                    ...
                    local TextLabel = library:create("TextLabel", {
                        ...
                        TextSize = 12,
                        BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                    }); library:apply_theme(TextLabel, "text", "TextColor3") 
        ...
        function library:tab(properties)
            ...
            -- Button
                ...
                local line = library:create("Frame", {
                    ...
                    Size = UDim2.new(1, 0, 0, 2),
                    BorderSizePixel = 0,
                    BackgroundColor3 = getDarkerColor(themes.preset.accent)
                })
            ...
            function cfg.open_tab()
                if library.current_tab and library.current_tab[1] ~= TAB_BUTTON then 
                    ...
                    parent.BackgroundColor3 = getDarkerColor(themes.preset.accent)
        ...
        function library:toggle(properties) 
            local cfg = {
                ...
                color = properties.risky or properties.risk or properties.color or properties.text_color or Color3.fromRGB(170, 170, 170),
        ...
        function library:slider(properties)
            ...
            local add = library:create("TextButton", {
                ...
                TextSize = 8,
                BackgroundColor3 = Color3.fromRGB(38, 38, 38)
            }); library:apply_theme(add, "text", "TextColor3") 
            ...
            local sub = library:create("TextButton", {
                ...
                TextSize = 12,
                BackgroundColor3 = Color3.fromRGB(38, 38, 38)
            }); library:apply_theme(sub, "text", "TextColor3") 
        ...
        function library:colorpicker(properties)            
            local cfg = {
                ...
                callback = properties.callback or function() end,
                animation = properties.animation or "normal",
                saved_color,
            ...
            -- Colorpicker Instances
                ...
                local __input = library:create("TextBox", {
                    ...
                    TextSize = 12,
                    BackgroundColor3 = Color3.fromRGB(38, 38, 38)
                }) library:apply_theme(__input, "text", "TextColor3") 
            ...
            -- Animation Handling 
                ...
                local normal = library:create("TextButton", {
                    ...
                    TextSize = 12,
                    BackgroundColor3 = Color3.fromRGB(65, 65, 65)
                }) library:apply_theme(normal, "text", "TextColor3") 
                ...
                local rainbow = library:create("TextButton", {
                    ...
                    TextSize = 12,
                    BackgroundColor3 = Color3.fromRGB(65, 65, 65)
                }) library:apply_theme(rainbow, "text", "TextColor3") 
                ...
                local fade = library:create("TextButton", {
                    ...
                    TextSize = 12,
                    BackgroundColor3 = Color3.fromRGB(65, 65, 65)
                }) library:apply_theme(fade, "text", "TextColor3") 
                ...
                local fade_alpha = library:create("TextButton", {
                    ...
                    TextSize = 12,
                    BackgroundColor3 = Color3.fromRGB(65, 65, 65)
                }) library:apply_theme(fade_alpha, "text", "TextColor3") 
        ...
        function library:keybind(properties) 
            local cfg = {
                ...
                keybind_name = properties.keybind_name or properties.listname or properties.list_name or nil, 
                callback = properties.callback or function() end,
                open = false,
                binding = nil, 
                name = properties.name or nil, 
            ...
            local key = library:new_keybind({cfg.keybind_name})
            ...
            -- Instances
                ...
                local keybind = library:create("TextButton", {
                    ...
                    TextSize = 12,
                    BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                }) library:apply_theme(keybind, "text", "TextColor3") 
                ...
                local press = library:create("TextButton", {
                    ...
                    TextSize = 12,
                    BackgroundColor3 = Color3.fromRGB(65, 65, 65)
                }) library:apply_theme(press, "text", "TextColor3") 
                ...
                local hold = library:create("TextButton", {
                    ...
                    TextSize = 12,
                    BackgroundColor3 = Color3.fromRGB(65, 65, 65)
                }) library:apply_theme(hold, "text", "TextColor3") 
                ...
                local always = library:create("TextButton", {
                    ...
                    TextSize = 12,
                    BackgroundColor3 = Color3.fromRGB(65, 65, 65)
                }) library:apply_theme(always, "text", "TextColor3") 
