...
local window = AddWindow({name = string.format('odyssey <font color="rgb(%d, %d, %d)">[v1.0]</font> | developed by source.lua', Library.Colors.Accent.R * 255, Library.Colors.Accent.G * 255, Library.Colors.Accent.B * 255),
        size = UDim2.new(0, 800, 0, 750),}) -- Initialize menu
do -- random
